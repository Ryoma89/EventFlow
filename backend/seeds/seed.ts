    ...
    const users = await User.insertMany([
      {
        ...
        photo: '../../tmp/images/user_image1.jpg',
      },
      {
        username: 'user1',
        email: 'user1@example.com',
        password: 'password123',
        photo: '../../tmp/images/user_image2.jpg',
      },
      {
        username: 'user2',
        email: 'user2@example.com',
        password: 'password123',
        photo: '../../tmp/images/user_image3.jpg',
      },
    ]);
    ...
    const events = await Event.insertMany([
      {
        ...
        imageUrl: '../../tmp/images/event_image1.jpg',
        price: '50',
        isFree: false,
      ...
      },
      {
        ...
        imageUrl: '../../tmp/images/event_image2.jpg',
        price: '30',
        isFree: false,
      ...
      },
      {
        ...
        imageUrl: '../../tmp/images/event_image3.jpg',
        price: 'Free',
        isFree: true,
      ...
      },
      {
        ...
        imageUrl: '../../tmp/images/event_image4.jpg',
        price: 'Free',
        isFree: true,
      ...
      },
      {
        ...
        imageUrl: '../../tmp/images/event_image5.jpg',
        price: 'Free',
        isFree: true,
      ...
      },
      {
        ...
        imageUrl: '../../tmp/images/event_image6.jpg',
        price: '200',
        isFree: false,
